...
#The script identifies the 'z' position of the MRF slice relative to the mp2rage image space. the z offset will be used later for z translation correction.
